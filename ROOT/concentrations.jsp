        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(2, request.getParameter("CONC"));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Concentration WHERE (num = ? AND conc = ?)");

                        pstmt.setString(
                            1, request.getParameter("NUM"));
												pstmt.setString(
                            2, request.getParameter("CONC"));
                        int rowCount = pstmt.executeUpdate();
                    ...
                    <tr>
                        <form action="concentrations.jsp" method="get">
                            ...
                            <th><input value="" name="NUM" size="10"></th>
			                      <th><input value="" name="CONC" size="15"></th>
                        ...
                        <form action="concentrations.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getString("num") %>" name="NUM">
													  <input type="hidden" 
                                value="<%= rs.getString("conc") %>" name="CONC">
                            <%-- Button --%>
                            <td>
