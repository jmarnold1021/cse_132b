...
<body>
  <table border="1">
        ...
        <tr>
            ...
            <td valign="top">
            <h1>Add Degree Concentrations</h1>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE DegreeConcentrations SET avg_cat_gpa = ?, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM DegreeConcentrations where name = ? AND deg_type = ? AND cat_type=?");
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery
                        ("SELECT * FROM DegreeConcentrations");
            %>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    <tr>
                        ...
                        <th>CONCENTRATION</th>
		                  	<th>REQ CONC GPA</th>
                        <th>REQ CONC UNITS</th>
                        <th>Action</th>
                    </tr>
                    <tr>
                        <form action="degreeconcentrations.jsp" method="get">
